...
Results_df. This joining required me to match the baker, series, and
episode. (cleaning up the resulting dataframe also involved deleting the
baker column that I recreated for the Bakers_df of only the first name
and retaining the first and last name ‘baker_name’ column).
